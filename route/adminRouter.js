...
router.post("/77topup/admin/add", validateGame, addGame);
router.put("/77topup/admin/game/edit", validateGame, updateGame);
...
router.post("/77topup/admin/package/add", addPackageGame);
