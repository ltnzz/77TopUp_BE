...
import { validateAddGame, validateAddPackages, validateUpdateGame, validateUpdatePackages } from "../middlewares/validation/validation-game.js";
...
router.post("/77topup/admin/game/add", upload.single('image'), validateAddGame, addGame);
...
router.post("/77topup/admin/package/add", upload.single('image'), validateAddPackages, addPackageGame);
router.put("/77topup/admin/package/edit", upload.single('image'), validateUpdatePackages, updatePackage);
